...
! function(e) {
    ...
    n.prototype.cache = o, n.prototype.define = function(e, t) {
        ...
        return r ? (o.event[l] = o.event[l] || {}, o.event[l][s] = [r], this) : (layui.each(o.event[l], function(e, t) { return "{*}" === s ? void layui.each(t, c) : ("" === e && layui.each(t, c), void(e === s && layui.each(t, c))) }), a)
    }, e.layui = new n
}(window);
    ...
    p.prototype.config = { type: "default", min: 0, max: 100, value: 0, step: 1, showstep: !1, tips: !0, input: !1, range: !1, height: 200, disabled: !1, theme: "#009688" }, p.prototype.render = function() {
        ...
        if (t.min = t.min < 0 ? 0 : t.min, t.range) {
            ...
            var r = Math.floor((t.value[0] - t.min) / (t.max - t.min) * 100),
                ...
                f = v - r + "%";
            r += "%", v += "%"
        } else { t.value = "object" == typeof t.value ? Math.min(t.value[0], t.value[1]) : t.value, t.value = t.value > t.min ? t.value : t.min; var f = Math.floor((t.value - t.min) / (t.max - t.min) * 100) + "%" }
        ...
        var n = this,
            ...
            x = function(e, i) {
                ...
                "vertical" === l.type ? (s.find("." + d).css({ bottom: e + "%", "margin-bottom": "20px" }), t = T(p() - h[0].offsetTop - h.height()), a = l.range ? T(p() - h[1].offsetTop - h.height()) : 0) : s.find("." + d).css("left", e + "%"), t = t > 100 ? 100 : t, a = a > 100 ? 100 : a;
                var n = Math.min(t, a),
                    o = Math.abs(t - a);
        ...
        var e = this;
        e.config
    }, t.render = function(e) { var i = new p(e); return a.call(i) }, e(n, t)
});
layui.define("jquery", function(e) {
    "use strict";
    var i = layui.jquery,
                    ...
                    var e, t = "请选择",
                        ...
                        y = function(t, u, f) {
                            ...
                            if (!u) {
                                ...
                                m.on("click", function(e) { t.hasClass(a + "ed") ? w() : (v(e, !0), C()), x.find("." + r).remove() }), m.find(".layui-edge").on("click", function() { k.focus() }), k.on("keyup", function(e) {
                                    var i = e.keyCode;
                                    9 === i && C()
                                ...
                                var T = function(e, t, a) {
                                    ...
                                    j = function(e) {
                                        var i = this.value,
                                            t = e.keyCode;
                                        return 9 !== t && 13 !== t && 37 !== t && 38 !== t && 39 !== t && 40 !== t && (T(i, function(e) { e ? x.find("." + r)[0] || x.append('<p class="' + r + '">无匹配项</p>') : x.find("." + r).remove() }, "keyup"), "" === i && x.find("." + r).remove(), void $())
                                    };
                                f && k.on("keyup", j).on("blur", function(t) {
                                    var a = p[0].selectedIndex;
                                    e = k, d = i(p[0].options[a]).html(), setTimeout(function() { T(k.val(), function(e) { d || k.val("") }, "blur") }, 200)
                                }), g.on("click", function() {
                                    var e = i(this),
                                        a = e.attr("lay-value"),
                                        n = p.attr("lay-filter");
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
    ...
    j.prototype.config = { limit: 10, loading: !0, cellMinWidth: 60, defaultToolbar: ["filter", "exports", "print"], text: { none: "无数据" } }, j.prototype.render = function() {
        var e = this,
            a = e.config;
        if (a.elem = t(a.elem), a.where = a.where || {}, a.id = a.id || a.elem.attr("id") || a.index, a.request = t.extend({ pageName: "page", limitName: "limit" }, a.request), a.response = t.extend({ statusName: "code", statusCode: 0, msgName: "msg", dataName: "data", countName: "count" }, a.response), "object" == typeof a.page && (a.limit = a.page.limit || a.limit, a.limits = a.page.limits || a.limits, e.page = a.page.curr = a.page.curr || 1, delete a.page.elem, delete a.page.jump), !a.elem[0]) return e;
        ...
        a.layTool.on("click", "*[lay-event]", function(e) {
            var i = t(this),
                ...
                u = function(e) {
                    ...
                    n.html(l), i.find(".layui-table-tool-panel")[0] || i.append(n), a.renderForm(), n.on("click", function(e) { layui.stope(e) }), e.done && e.done(n, l)
                };
        ...
        }).on("mouseup", function(t) { u.resizeStart && (u = {}, c.css("cursor", ""), a.scrollPatch()), 2 === e && (e = null) }), h.on("click", function(i) {
            var l, n = t(this),
                o = n.find(L),
                r = o.attr("lay-sort");
        ...
        a.elem.on("click", 'input[name="layTableCheckbox"]+', function() {
            ...
            o ? (i.each(function(e, t) { t.checked = n, a.setCheckData(e, n) }), a.syncCheckAll(), a.renderForm("checkbox")) : (a.setCheckData(l, n), a.syncCheckAll()), layui.event.call(this, s, "checkbox(" + p + ")", v.call(this, { checked: n, type: o ? "all" : "one" }))
        }), a.elem.on("click", 'input[lay-type="layTableRadio"]+', function() {
            var e = t(this).prev(),
                i = e[0].checked,
                l = d.cache[a.key],
                n = e.parents("tr").eq(0).data("index");
            layui.each(l, function(e, t) { n === e ? t.LAY_CHECKED = !0 : delete t.LAY_CHECKED }), a.setThisRowChecked(n), layui.event.call(this, s, "radio(" + p + ")", v.call(this, { checked: i }))
        ...
        }).on("click", "tr", function() { m.call(this, "row") }).on("dblclick", "tr", function() { m.call(this, "rowDouble") }).on("contextmenu", "tr", function() {
            m.call(this, "mouseRightMenu")
            return false;
        });;
        var m = function(e) {
            var i = t(this);
        ...
        a.layBody.on("change", "." + S, function() {
            ...
            var e = t(this),
                ...
                a = e.children(f);
            if (!e.data("off") && i) { var l = t('<input class="layui-input ' + S + '">'); return l[0].value = e.data("content") || a.text(), e.find("." + S)[0] || e.append(l), void l.focus() }
        }).on("mouseenter", "td", function() { x.call(this) }).on("mouseleave", "td", function() { x.call(this, "hide") });
        ...
        }), H.on("click", function() { H.trigger("table.remove.tool.panel") }), H.on("table.remove.tool.panel", function() { t(".layui-table-tool-panel").remove() }), R.on("resize", function() { a.fullSize(), a.scrollPatch(), a.setColsWidth() })
    }, d.init = function(e, i) {
        i = i || {};
        var a = this,
